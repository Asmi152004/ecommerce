<h1>🛒 Aura - Full-Stack E-Commerce Website</h1>

<p>
    Aura is a fully functional e-commerce platform built with the <strong>MERN stack</strong> (MongoDB, Express, React, Node.js). 
